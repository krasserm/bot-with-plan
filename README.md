...
- [Separation of planning concerns in ReAct-style LLM agents](example_agent.ipynb) ([blog post](https://krasserm.github.io/2024/03/06/modular-agent/)).
...
- [Schema-guided generation with open LLMs](example_json.ipynb) ([blog post](https://krasserm.github.io/2023/12/18/llm-json-mode/)).
...
- [Schema-guided generation in LangChain agents](https://github.com/krasserm/grammar-based-agents/blob/wip-article-1/example_agent.ipynb) ([blog post](https://krasserm.github.io/2023/12/10/grammar-based-agents/)).
